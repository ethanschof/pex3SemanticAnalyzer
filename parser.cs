...
public class Parser
{
    ...
    ArrayList New0()
    {
        ...
        PMainState pmainstateNode4 = (PMainState)nodeArrayList3[0];
    ...
    ArrayList New1()
    {
        ...
        AMainState pmainstateNode1 = new AMainState (
              tmaindefNode2,
              topenbracketNode3,
              pstatementsNode4,
              tclosebracketNode5
        );
        nodeList.Add(pmainstateNode1);
        return nodeList;
    }
    ArrayList New2()
    {
    ...
    private static int[] errors = {
      0, 1, 2, 3, 0, 1, 1, 4, 3, 3, 5, 6, 7, 2, 4, 8, 
      9, 10, 11, 11, 8, 12, 12, 12, 12, 13, 14, 15, 16, 17, 12, 12, 
      12, 12, 1, 18, 19, 6, 6, 20, 21, 10, 10, 10, 10, 10, 10, 12, 
      12, 22, 0, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 19, 
      7, 9, 8, 8, 8, 23, 24, 2, 21, 12, 14, 15, 16, 16, 17, 17, 
      17, 17, 12, 12, 12, 12, 10, 18, 25, 25, 13, 18, 19, 26, 10, 21, 
      7, 7, 10, 24, 23, 3, 10, 10, 10, 18, 21, 21, 27, 10, 7, 10, 
      21, 10, 
    };
}
}
